...
local plug_map = {
	...
	-- Plugin auto_session
	["n|<leader>sl"] = map_cu("SessionManager load_session"):with_noremap(),
	["n|<leader>ss"] = map_cu("SessionManager save_current_session"):with_noremap(),
	["n|<leader>sf"] = map_cu("SessionManager load_current_dir_session"):with_noremap(),
	["n|<leader>sr"] = map_cu("SessionManager load_last_session"):with_noremap(),
	["n|<leader>sd"] = map_cu("SessionManager delete_session"):with_noremap(),
...
local lsp_map = {
	...
	-- ["v|<leader>ca"] = map_cu("lua vim.lsp.buf.range_code_action()"):with_noremap():with_silent(),
